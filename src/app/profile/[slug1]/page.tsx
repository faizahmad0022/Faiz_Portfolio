    ...
    if (typeof window !== "undefined") {
      const fetchDataAndUpdateState = async () => {
        ...
        try {
          ...
          const profileId = !isNaN(parsedId) && Number.isInteger(parsedId) && parsedId < 7 && parsedId > 0 ? parsedId : 2;
  ...
  return (
    ...
    <div>
                    ...
                    <div className="hidden lg:block h-full">
                      ...
                      >
                        ...
                        >
                          <Image
                            alt="Profile Pic"
                            src={(!!portfolioData?.data?.profilePic) ? (portfolioData?.data?.profilePic) : ("")}
                            width={0}
                            height={0}
                            sizes="100vw"
      ...
      <section className="fixed lg:hidden bottom-0 left-0 bg-slate-500 w-full py-3">
       ...
       <Navbar id={id} currentPage={'profile'}/>
    </div>
  );
}
